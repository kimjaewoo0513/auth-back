...
import com.demo.auth.jwt.exception.JwtExceptionCode;
import com.demo.auth.jwt.token.JwtAuthenticationToken;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	private void getAuthentication(String token) {
		...
		// token 객체를 넘겼을때 authenticationManager가 문제가 없는 토큰인지 확인
